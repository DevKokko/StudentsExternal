          ...
          <div style="padding:25px;margin: 0 auto;">
            ...
            <form action="" method="POST" id="myForm" style="padding: 25px 50px;background-color: white;border-radius: 10px;margin:0 auto;width: 500px;max-width:90%;padding: 25px 50px;outline: 2px solid lightgray;" >
              ...
              <div style="text-align:center;margin-top:20px;">
                <p>
                  <a href="applicationform.php" class="btn btn-primary" style="width:170px;">Application Form</a>
                </p>
                <p>
                  <a href="applicationstatus.php" class="btn btn-primary" style="width:170px;">Application Status</a>
                </p>
                <p>
                  <a href="editprofile.php" class="btn btn-primary" style="width:170px;">Edit Profile</a>
                </p>
              </div>
            </form>
